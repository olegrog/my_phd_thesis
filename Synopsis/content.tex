...
Во-первых, это одномерные \emph{плоско-параллельные течения} при конечных числах Маха.
...
используется альтернативная форма столкновительного интеграла
\begin{equation*}
...
В частности, для степенного молекулярного потенциала (\(\Gamma_2=\gamma_2T^s\), \(\Gamma_7=\gamma_7T^{2s-1}\)) можно записать
\begin{equation*}
...
\underline{\textbf{Приложение}} состоит из двух частей.
Первая часть содержит вывод одномерных интегральных уравнений Фредгольма из линеаризованного уравнения Больцмана
...
Вторая часть описывает алгоритм многомерного интегрирования по правилам Коробова.
